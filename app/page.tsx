    ...
    return (
        <div className="">
            ...
            <div className="text-center my-5 text-white">
                <h1 className="text-5xl font-bold my-2 tracking-wide">Stock Market Simulator</h1>
                <h1 className="text-3xl font-bold my-2 text-primary">Trade stocks with virtual currency</h1>
            </div>

            <div className="flex justify-center">
                <div className="mockup-browser border bg-base-300 w-2/3 rounded-b-none shadow-lg">
                    <div className="mockup-browser-toolbar">
                        <div className="input">https://VIRTUALSTOCKMARKET.com</div>
                    </div>
                    <div className="flex justify-center bg-base-200">
                        <img src="https://i.imgur.com/V5k9XxQ.png" alt="" />
                    </div>
                </div>
            </div>

            <div className="bg-white flex text-black overflow-x-hidden">
                <div className="flex flex-col basis-1/2 justify-center m-10">
                    <h1 className="text-3xl font-bold my-2">
                        Start with a virtual $1,000 to practice stock trading
                    </h1>
                    <p className="text-xl my-2">
                        No deposit needed. Practice trading with virtual money to sharpen your knowledge of how the stock market works and how to use an online brokerage.
                    </p>
                </div>
            ...
            <div className="bg-secondary text-white flex">
                <div className="flex flex-col basis-1/2 justify-center">
                    <h1 className="text-3xl font-bold m-10">Search Stocks</h1>
                </div>
