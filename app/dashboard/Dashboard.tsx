    ...
    return(
        <div className="flex bg-[#1B2627] w-screen h-screen text-white">
            ...
            <div className='hidden lg:flex flex-col p-3 '>
                ...
                <div className='text-xl w-full py-3 bg-slate-400 p-5 bg-opacity-50 rounded-full'>
                    Dashboard
                </div>
            </div>
                    ...
                    <div className='p-5 rounded-lg bg-[#202C2D] m-2 flex-grow'>
                        ...
                        <div>
                            <form action="/auth/signout" method="post">
                                <button className="button block bg-[#B2F35F] hover:bg-[#8ec24c] text-black py-2 px-4 rounded-md my-2 font-semibold" type="submit">
                                    Sign out
                                </button>
                            </form>
                        </div>
